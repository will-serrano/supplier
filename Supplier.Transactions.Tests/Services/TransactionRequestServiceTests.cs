...
namespace Supplier.Transactions.Tests.Services
{
    public class TransactionRequestServiceTests
    {
        ...
        private readonly Mock<IJwtSecurityTokenHandlerWrapper> _tokenHandlerWrapperMock;
        ...
        public TransactionRequestServiceTests()
        {
            ...
            _tokenHandlerWrapperMock = new Mock<IJwtSecurityTokenHandlerWrapper>();
            ...
            _service = new TransactionRequestService(
                ...
                _tokenHandlerWrapperMock.Object,
                _loggerMock.Object);
        }
        ...
        public async Task RequestTransactionAsync_ValidRequest_ReturnsApprovedResponse()
        {
            ...
            var dto = new TransactionRequestDto { CustomerId = "123", Amount = 100 };
            ...
            // Act
            var result = await _service.RequestTransactionAsync(dto, userId, _token);
        ...
        public async Task RequestTransactionAsync_InvalidRequest_ThrowsValidationException()
        {
            ...
            // Act & Assert
            await Assert.ThrowsAsync<ValidationException>(() => _service.RequestTransactionAsync(dto, userId, _token));
        }
